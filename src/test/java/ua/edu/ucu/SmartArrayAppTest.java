...
public class SmartArrayAppTest {
    ...
    public void testFilterPositiveIntegersSortAndMultiplyByTwo() {
        ...
        Integer[] res = SmartArrayApp.ftrPositiveIntegersSortAndMultiplyByTwo(integers);
    ...
    public void testFindDistinctStudentNamesFrom2ndYearWithGPAgt4AndOrderedBySurname() {
        ...
        String[] studentNames = SmartArrayApp.findDistinctStudentNamesFromSecondYearWithGPAgeFourAndOrderedBySurname(students);
